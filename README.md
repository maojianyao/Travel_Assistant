...
<div align="center">
  <img src="docs/images/home.png" width="800" alt="首页 - 行程表单页"/>
  <p><b>首页</b>：填写目的地与出行日期，一键生成旅行计划</p>
  <img src="docs/images/trip_result_page.png" width="800" alt="结果页 - 行程展示"/>
  <p><b>结果页</b>：地图景点标注、每日行程安排、预算明细与一键导出</p>
</div>
